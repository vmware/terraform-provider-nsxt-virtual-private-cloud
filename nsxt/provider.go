...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"nsxt_vpc_service":                       dataSourceNsxtVpcService(),
			...
			"nsxt_vpc_ip_address_block":              dataSourceNsxtVpcIpAddressBlock(),
			"nsxt_vpc_static_routes":                 dataSourceNsxtVpcStaticRoutes(),
			"nsxt_vpc_policy_context_profile":        dataSourceNsxtVpcPolicyContextProfile(),
			"nsxt_vpc_security_policy":               dataSourceNsxtVpcSecurityPolicy(),
			"nsxt_vpc_ip_address_pool":               dataSourceNsxtVpcIpAddressPool(),
